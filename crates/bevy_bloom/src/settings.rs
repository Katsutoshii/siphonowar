...
use bevy::ecs::{prelude::Component, query::QueryItem, reflect::ReflectComponent};
use bevy::math::{AspectRatio, URect, UVec4, Vec4};
use bevy::reflect::{std_traits::ReflectDefault, Reflect};
use bevy::render::{extract_component::ExtractComponent, prelude::Camera};
...
pub struct CustomBloomSettings {
...
impl Default for CustomBloomSettings {
    fn default() -> Self {
        Self::NATURAL
    }
}
...
impl ExtractComponent for CustomBloomSettings {
